...
// ── 簡繁轉換表 ────────────────────────────────────────────────
const S2T_MAP = {"爱":"愛","罢":"罷","备":"備","贝":"貝","笔":"筆","毕":"畢","边":"邊","变":"變","标":"標","别":"別","补":"補","参":"參","产":"產","长":"長","场":"場","车":"車","称":"稱","齿":"齒","冲":"衝","虫":"蟲","处":"處","传":"傳","从":"從","错":"錯","达":"達","带":"帶","单":"單","导":"導","灯":"燈","点":"點","电":"電","东":"東","动":"動","断":"斷","队":"隊","对":"對","发":"發","飞":"飛","费":"費","风":"風","复":"復","盖":"蓋","干":"乾","刚":"剛","个":"個","给":"給","够":"夠","关":"關","观":"觀","广":"廣","过":"過","还":"還","汉":"漢","号":"號","后":"後","护":"護","话":"話","画":"畫","怀":"懷","换":"換","黄":"黃","会":"會","机":"機","极":"極","几":"幾","际":"際","继":"繼","价":"價","见":"見","将":"將","奖":"獎","节":"節","尽":"盡","经":"經","举":"舉","开":"開","块":"塊","来":"來","劳":"勞","乐":"樂","类":"類","离":"離","历":"歷","联":"聯","两":"兩","临":"臨","灵":"靈","龙":"龍","楼":"樓","乱":"亂","妈":"媽","买":"買","满":"滿","门":"門","灭":"滅","难":"難","内":"內","脑":"腦","鸟":"鳥","农":"農","强":"強","亲":"親","区":"區","热":"熱","认":"認","时":"時","实":"實","书":"書","树":"樹","说":"說","岁":"歲","台":"臺","态":"態","体":"體","听":"聽","头":"頭","团":"團","万":"萬","为":"為","问":"問","无":"無","务":"務","习":"習","现":"現","线":"線","乡":"鄉","响":"響","协":"協","写":"寫","寻":"尋","学":"學","选":"選","压":"壓","严":"嚴","样":"樣","业":"業","义":"義","应":"應","营":"營","拥":"擁","优":"優","鱼":"魚","语":"語","园":"園","远":"遠","运":"運","战":"戰","这":"這","证":"證","种":"種","众":"眾","转":"轉","装":"裝","状":"狀","资":"資","总":"總","组":"組",'爷':"爺","奶":"奶","爹":"爹","娘":"娘","师":"師","徒":"徒","剑":"劍","侠":"俠","仙":"仙","魔":"魔","妖":"妖","鬼":"鬼","阵":"陣","灵":"靈","魂":"魂","体":"體","气":"氣","丹":"丹","药":"藥","宗":"宗","派":"派","门":"門","阁":"閣","殿":"殿","宫":"宮","城":"城","界":"界","域":"域","境":"境","级":"級","阶":"階","品":"品","修":"修","炼":"煉","突":"突","破":"破","晋":"晉","升":"升","降":"降","落":"落","坠":"墜","飞":"飛","天":"天","地":"地","人":"人","神":"神","佛":"佛","圣":"聖","帝":"帝","王":"王","皇":"皇","族":"族","血":"血","脉":"脈","丝":"絲","线":"線","力":"力","功":"功","法":"法","术":"術","诀":"訣","招":"招","式":"式","掌":"掌","拳":"拳","剑":"劍","刀":"刀","枪":"槍","棍":"棍","鞭":"鞭","弓":"弓","箭":"箭","盾":"盾","铠":"鎧","甲":"甲","袍":"袍","衣":"衣","裳":"裳","帽":"帽","冠":"冠","带":"帶","环":"環","戒":"戒","珠":"珠","玉":"玉","石":"石","矿":"礦","金":"金","银":"銀","铜":"銅","铁":"鐵","钢":"鋼","丝":"絲","布":"布","锦":"錦","绸":"綢","纱":"紗","绢":"絹","纹":"紋","阵":"陣","符":"符","印":"印","咒":"咒","禁":"禁","封":"封","解":"解","破":"破","灭":"滅","杀":"殺","战":"戰","斗":"鬥","打":"打","击":"擊","攻":"攻","守":"守","防":"防","逃":"逃","追":"追","逐":"逐","寻":"尋","找":"找","得":"得","失":"失","胜":"勝","败":"敗","赢":"贏","输":"輸","死":"死","活":"活","生":"生","亡":"亡","伤":"傷","愈":"癒","治":"治","救":"救","护":"護","爱":"愛","恨":"恨","情":"情","义":"義","恩":"恩","仇":"仇","怨":"怨","恩":"恩","德":"德","善":"善","恶":"惡","正":"正","邪":"邪","光":"光","暗":"暗","阴":"陰","阳":"陽","冷":"冷","热":"熱","火":"火","水":"水","风":"風","雷":"雷","土":"土","木":"木","金":"金","冰":"冰","毒":"毒","幻":"幻","空":"空","虚":"虛","实":"實","真":"真","假":"假","梦":"夢","醒":"醒","睡":"睡","眠":"眠"};
function s2t(text) { return text.split("").map(c => S2T_MAP[c] || c).join(""); }

// ── 詞彙層級簡繁對照（小說常用）────────────────────────────────
const WORD_MAP = [
  ["出租车","計程車"],["手机","手機"],["电脑","電腦"],["电话","電話"],
  ["电视","電視"],["电影","電影"],["电梯","電梯"],["电池","電池"],
  ["网络","網路"],["网站","網站"],["网页","網頁"],["软件","軟體"],
  ["硬件","硬體"],["视频","影片"],["音乐","音樂"],["图片","圖片"],
  ["文件","檔案"],["程序","程式"],["系统","系統"],["设备","設備"],
  ["信息","資訊"],["消息","訊息"],["新闻","新聞"],["报纸","報紙"],
  ["杂志","雜誌"],["书店","書店"],["图书馆","圖書館"],["学校","學校"],
  ["大学","大學"],["中学","中學"],["小学","小學"],["老师","老師"],
  ["同学","同學"],["学生","學生"],["作业","作業"],["考试","考試"],
  ["成绩","成績"],["毕业","畢業"],["工作","工作"],["公司","公司"],
  ["老板","老闆"],["同事","同事"],["工资","薪水"],["假期","假期"],
  ["旅游","旅遊"],["机场","機場"],["火车站","火車站"],["地铁","捷運"],
  ["公交车","公車"],["出租车","計程車"],["自行车","腳踏車"],["汽车","汽車"],
  ["医院","醫院"],["医生","醫生"],["护士","護士"],["药店","藥局"],
  ["超市","超市"],["商场","商場"],["餐厅","餐廳"],["咖啡店","咖啡廳"],
  ["银行","銀行"],["邮局","郵局"],["警察局","警察局"],["政府","政府"],
  ["爸爸","爸爸"],["妈妈","媽媽"],["哥哥","哥哥"],["姐姐","姐姐"],
  ["弟弟","弟弟"],["妹妹","妹妹"],["爷爷","爺爺"],["奶奶","奶奶"],
  ["外公","外公"],["外婆","外婆"],["叔叔","叔叔"],["阿姨","阿姨"],
  ["朋友","朋友"],["男朋友","男朋友"],["女朋友","女朋友"],["丈夫","丈夫"],
  ["妻子","妻子"],["孩子","孩子"],["儿子","兒子"],["女儿","女兒"],
  // 武俠/仙俠常用
  ["功夫","功夫"],["武功","武功"],["内力","內力"],["真气","真氣"],
  ["灵力","靈力"],["仙力","仙力"],["魔力","魔力"],["神力","神力"],
  ["修炼","修煉"],["修行","修行"],["突破","突破"],["晋级","晉級"],
  ["境界","境界"],["丹药","丹藥"],["灵丹","靈丹"],["妙药","妙藥"],
  ["法宝","法寶"],["灵宝","靈寶"],["神器","神器"],["魔器","魔器"],
  ["剑气","劍氣"],["刀光","刀光"],["掌力","掌力"],["拳劲","拳勁"],
  ["轻功","輕功"],["身法","身法"],["步法","步法"],["剑法","劍法"],
  ["刀法","刀法"],["拳法","拳法"],["掌法","掌法"],["心法","心法"],
  ["口诀","口訣"],["秘籍","秘籍"],["武学","武學"],["武道","武道"],
  ["江湖","江湖"],["门派","門派"],["宗门","宗門"],["帮派","幫派"],
  ["长老","長老"],["掌门","掌門"],["弟子","弟子"],["师父","師父"],
  ["师傅","師傅"],["师兄","師兄"],["师弟","師弟"],["师姐","師姐"],
  ["师妹","師妹"],["大师","大師"],["高手","高手"],["强者","強者"],
  ["弱者","弱者"],["废物","廢物"],["天才","天才"],["奇才","奇才"],
  // 現代言情常用
  ["总裁","總裁"],["董事长","董事長"],["总经理","總經理"],["秘书","秘書"],
  ["助理","助理"],["律师","律師"],["医师","醫師"],["教授","教授"],
  ["警察","警察"],["侦探","偵探"],["记者","記者"],["演员","演員"],
  ["歌手","歌手"],["模特","模特"],["设计师","設計師"],["程序员","程式設計師"],
  ["豪门","豪門"],["富豪","富豪"],["千金","千金"],["公子","公子"],
  ["霸道","霸道"],["温柔","溫柔"],["冷酷","冷酷"],["腹黑","腹黑"],
  ["傲娇","傲嬌"],["乖巧","乖巧"],["活泼","活潑"],["内敛","內斂"],
];

function applyWordMap(text) {
  let result = text;
  for (const [simp, trad] of WORD_MAP) {
...
function parseFile(ab, name) {
  ...
  if (name.toLowerCase().endsWith(".epub")) {
    ...
    text = result.text;
    // GBK = 簡體 → 自動轉繁體
    if (result.enc === "gbk") { text = applyWordMap(text); text = s2t(text); }
  }
  return text;
}
...
export default function App() {
  ...
  return (
    <div style={{ background:rbg, color:rtc, fontFamily:"Georgia,'Noto Serif TC',serif", display:"flex", flexDirection:"column", height:"100vh", width:"100vw", overflow:"hidden", filter:`brightness(${bright})` }}
      ...
      {/* 內文 — 禁止滾動，固定顯示 */}
      <div ref={rdr} style={{ flex:1, overflow:"hidden", padding:"24px 24px 8px 24px", lineHeight:1.95, fontSize:fs, color:rtc, whiteSpace:"pre-wrap", wordBreak:"break-word" }}>
        {pageText}
      </div>
