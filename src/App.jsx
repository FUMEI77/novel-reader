...
export default function App() {
  ...
  return (
    <div style={{ background:rbg, color:rtc, fontFamily:"Georgia,'Noto Serif TC',serif", display:"flex", flexDirection:"column", height:"100vh", width:"100vw", overflow:"hidden", filter:`brightness(${bright})` }}
      ...
      {/* 內文 — 左右 padding 完全對稱，不用 maxWidth */}
      <div ref={rdr} style={{ flex:1, overflowY:"auto", padding:"24px 24px", lineHeight:1.95, fontSize:fs, color:rtc, whiteSpace:"pre-wrap", wordBreak:"break-word", WebkitOverflowScrolling:"touch" }}>
        {pageText}
        <div style={{ height:16 }} />
      </div>
